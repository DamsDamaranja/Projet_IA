% ==========================
% Projet IA - Enquête policière avec interface
% ==========================
...
% Charger les faits et règles de l'enquête
...
% Lancer le serveur avec ?- serveur(8080).
serveur(Port) :-
...
accueil(_Request) :-
    reply_html_page(
        title('Enquête policière'),
        [ h1('Système Expert - Enquête'),
